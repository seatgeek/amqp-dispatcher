# AMQP Dispatcher [![Build Status](https://travis-ci.org/philipcristiano/amqp-dispatcher.svg?branch=master)](https://travis-ci.org/philipcristiano/amqp-dispatcher)
