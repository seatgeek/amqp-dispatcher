# AMQP Dispatcher [![Build Status](https://travis-ci.org/philipcristiano/amqp-dispatcher.svg?branch=v0.3.0)](https://travis-ci.org/philipcristiano/amqp-dispatcher)
